// Ruth's About Me copy, in her exact wording and her order.
// Shared because it now renders in two places: the About Me page and the
// homepage, where Ruth asked for it open in full rather than behind a button.
